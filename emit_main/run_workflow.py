...
from emit_main.workflow.l2a_tasks import L2AMask, L2AReflectance, L2AFormat, L2ADeliver, L2AMaskTf
...
def parse_args():
    product_choices = ["l0hosc", "l0daac", "l0plan", "l0bad", "l1aeng", "l1aframe", "l1aframereport", "l1araw",
                       ...
                       "l2amask", "l2amaskTf", "l2aformat", "l2adaac", "l2babun", "l2bformat", "l2bdaac", "l2bch4", "l2bco2",
...
def task_failure(task, e):
    ...
    acquisition_tasks = ("emit.L1ADeliver", "emit.L1BCalibrate", "emit.L1BRdnFormat", "emit.L1BRdnDeliver",
                         "emit.L2AReflectance", "emit.L2AMask", "emit.L2AMaskTf", "emit.L2AFormat", "emit.L2ADeliver",
