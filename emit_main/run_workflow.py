...
def get_tasks_from_product_args(args):
    ...
    prod_task_map = {
        ...
        "l2aformatTf": L2AFormatTf(acquisition_id=args.acquisition_id, **kwargs),
...
def task_failure(task, e):
    ...
    acquisition_tasks = ("emit.L1ADeliver", "emit.L1BCalibrate", "emit.L1BRdnFormat", "emit.L1BRdnDeliver",
                         "emit.L2AReflectance", "emit.L2AMask", "emit.L2AMaskTf", "emit.L2AFormat",  "emit.L2AFormatTf", 
                         "emit.L2ADeliver", "emit.L2BAbundance", "emit.L2BFormat", "emit.L2BDeliver", "emit.L3Unmix",
