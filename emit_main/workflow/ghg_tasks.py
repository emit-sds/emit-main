...
class GHG(SlurmJobTask):
    ...
    def work(self):
        ...
        ch4_cmd = cmd + [ch4_target_file, wm.config["ch4_lut_file"], "--logfile", ch4_log_file]
        co2_cmd = cmd + [co2_target_file, wm.config["co2_lut_file"], "--logfile", co2_log_file, "--co2"]
        co2_cmd[8] = co2_base
        ...
        # Update db
        dm.update_acquisition_metadata(acq.acquisition_id, {"preducts.ghg.ch4": {
                "img_path" : acq.ch4_img_path,
                "hdr_path" : acq.ch4_hdr_path,
                "created" : datetime.datetime.now(tz=datetime.timezone.utc)}})
        dm.update_acquisition_metadata(acq.acquisition_id, {"preducts.ghg.sensch4": {
                "img_path" : acq.sensch4_img_path,
                "hdr_path" : acq.sensch4_hdr_path,
                "created" : datetime.datetime.now(tz=datetime.timezone.utc)}})
        dm.update_acquisition_metadata(acq.acquisition_id, {"preducts.ghg.uncertch4": {
                "img_path" : acq.uncertch4_img_path,
                "hdr_path" : acq.uncertch4_hdr_path,
                "created" : datetime.datetime.now(tz=datetime.timezone.utc)}})
        dm.update_acquisition_metadata(acq.acquisition_id, {"preducts.ghg.ortch4": {
                "tif_path" : acq.ortch4_img_path,
                "created" : datetime.datetime.now(tz=datetime.timezone.utc)}})
        dm.update_acquisition_metadata(acq.acquisition_id, {"preducts.ghg.ortsensch4": {
                "tif_path" : acq.ortsensch4_img_path,
                "created" : datetime.datetime.now(tz=datetime.timezone.utc)}})
        dm.update_acquisition_metadata(acq.acquisition_id, {"preducts.ghg.ortuncertch4": {
        ...
        # Update db
        dm.update_acquisition_metadata(acq.acquisition_id, {"preducts.ghg.co2": {
                "img_path" : acq.co2_img_path,
                "hdr_path" : acq.co2_hdr_path,
                "created" : datetime.datetime.now(tz=datetime.timezone.utc)}})
        dm.update_acquisition_metadata(acq.acquisition_id, {"preducts.ghg.sensco2": {
                "img_path" : acq.sensco2_img_path,
                "hdr_path" : acq.sensco2_hdr_path,
                "created" : datetime.datetime.now(tz=datetime.timezone.utc)}})
        dm.update_acquisition_metadata(acq.acquisition_id, {"preducts.ghg.uncertco2": {
                "img_path" : acq.uncertco2_img_path,
                "hdr_path" : acq.uncertco2_hdr_path,
                "created" : datetime.datetime.now(tz=datetime.timezone.utc)}})
        dm.update_acquisition_metadata(acq.acquisition_id, {"preducts.ghg.ortco2": {
                "tif_path" : acq.ortco2_img_path,
                "created" : datetime.datetime.now(tz=datetime.timezone.utc)}})
        dm.update_acquisition_metadata(acq.acquisition_id, {"preducts.ghg.ortsensco2": {
                "tif_path" : acq.ortsensco2_img_path,
                "created" : datetime.datetime.now(tz=datetime.timezone.utc)}})
        dm.update_acquisition_metadata(acq.acquisition_id, {"preducts.ghg.ortuncertco2": {
