...
#### [v1.6.17](https://github.com/emit-sds/emit-main/compare/v1.6.14...v1.6.17)
...
#### [v1.6.14](https://github.com/emit-sds/emit-main/compare/v1.6.12...v1.6.14)
...
- Move 0 byte HOSC files to ingest/errors. Add number of orbits and dcids inserted in planning product log. [`0096c03`](https://github.com/emit-sds/emit-main/commit/0096c03df375edbd2db1e0896a3f5cdc8e2ace8e)
...
- Add L2ARflDeliver task with l2arfldaac product choice [`d3f1c1d`](https://github.com/emit-sds/emit-main/commit/d3f1c1d982e192d1f588bf3fadffa8ac23d6fa8b)
